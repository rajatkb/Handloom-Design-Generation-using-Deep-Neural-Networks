...
class Fast_Style_transfer:
    ...
    def loss_model(self ,generator_input, generator_output , shape, content_image_location , texture_image_location):
    ...
    def __init__(self ,content_image=None, texture_image=None, test_folder=None , shape=(256,256,3) , lr=0.0001 ,chk = -1 , lambda_tv=0, lambda_content = 0 , lambda_texture = 0 , test=False, model_name="model.h5"):
...
if __name__=='__main__':
    ...
    model = Fast_Style_transfer(shape=(256,256,3) , lr=learning_rate ,chk = chk , lambda_tv=lambda_tv, lambda_content = lambda_content , lambda_texture = lambda_texture ,content_image = content_image, texture_image = texture_image, test_folder=train_folder ,test=test , model_name=model_name)
